...
const Section1 = () => {
    ...
    <section className="w-[1280px] h-[1028px] font-roboto">
           <div className="flex justify-between md:flex-row flex-col items-center w-[1280px]">
            <div className="w-[640px] h-[300px] xl:pr-[60px] pl-[10px] md:w-1/2 flex flex-col gap-[24px] xl:my-[250px] xl:pl-[80px] lg:my-[170px] md:my-[14px]">
            ...
            <Image src={'/pic.png'} alt="picture" layout="fill" objectFit="cover" className="rounded-md"  />
            </div>
           </div>
           
           <div className="bg-[#f7f7f7] h-[228px]  gap-[64px] justify-between w-[1280px] flex py-8 mt-8">
